...
def custom_admin_index(request):
    ...
    # Contar alertas de PowerBI (en esquema público)
    try:
        from powerbi_handler.models import PowerBIAlert
        total_powerbi_alerts = PowerBIAlert.objects.count()
    except:
        total_powerbi_alerts = 0

    context.update({
        'companies_count': companies.count(),
        'total_users': total_users,
        'total_bots': total_bots,
        'total_powerbi_alerts': total_powerbi_alerts,
    })
